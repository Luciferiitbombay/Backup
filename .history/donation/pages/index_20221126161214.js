  ...
  return (
    <HomeWrapper>
      ...
      <FilterWrapper>
        ...
        <Categorys onClick={()=> setFilter(Health)}>Health</Categorys>
        <Categorys onClick={()=> setFilter(Education)}>Education</Categorys>
        <Categorys onClick={()=> setFilter(Animal)}>Animal</Categorys>
      </FilterWrapper>
...
export async function getStaticProps(){
  ...
  const getEducationCampaigns=contract.filters.campaignCreated(null,null,null,null,null,null,'health');
  ...
  const getAnimalCampaigns=contract.filters.campaignCreated(null,null,null,null,null,null,'health');
